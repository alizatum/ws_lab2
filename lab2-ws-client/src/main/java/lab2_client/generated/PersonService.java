 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://lab1_ws/", wsdlLocation = "http://localhost:8080/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://lab1_ws/", "PersonService");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://lab1_ws/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab1_ws/", "PersonWebServicePort"), PersonWebService.class, features);
    }
